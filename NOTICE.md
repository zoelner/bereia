...
Este projeto utiliza dados de terceiros. Cada fonte baixada mantém seu `LICENSE.txt` em `data/sources/<fonte>/` com origem, licença e data de obtenção.
...
- **Treasury of Scripture Knowledge (TSK)** — domínio público (alternativa às cross-references da OpenBible.info)

## Software

- **BAAI/bge-m3** (modelo de embeddings) — MIT — https://huggingface.co/BAAI/bge-m3
